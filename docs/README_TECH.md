...
はじめての方は [はじめてのガイド（8言語）](guide/README.md) をどうぞ。
New here? Start with the [getting-started guide (8 languages)](guide/README.md) .
...
詳しくは [PROVIDERS.md](PROVIDERS.md)。
...
書き換えが要らない。詳しくは [VECTOR_STORES.md](VECTOR_STORES.md)。
...
elsewhere. See [AGENTS.md](AGENTS.md).
...
（詳しくは [DEPLOY-ORACLE.md](DEPLOY-ORACLE.md)）。並列グループの
中の工程も、それぞれ個別に記録される。
...
[DEPLOY-ORACLE.md](DEPLOY-ORACLE.md)). Steps inside a parallel group
...
| | |
|---|---|
| [guide/](guide/README.md) | 入門ガイド（8言語）/ getting started |
| [INSTALL.md](INSTALL.md) | インストール / installation |
| [MOBILE.md](MOBILE.md) | スマホから使う・権限分離 / phone access and roles |
| [PROVIDERS.md](PROVIDERS.md) | AI の提供元 / AI providers |
| [AGENTS.md](AGENTS.md) | エージェント / agents |
| [VECTOR_STORES.md](VECTOR_STORES.md) | ベクトルストアの選択肢 / vector store choices |
| [SCHEDULER.md](SCHEDULER.md) | 定時実行 / scheduling |
| [TEAMS.md](TEAMS.md) | Teams 連携 / Teams |
| [JIRA-SLACK.md](JIRA-SLACK.md) | Jira と Slack |
| [AGILE.md](AGILE.md) | スプリント / sprints |
| [INDUSTRIES.md](INDUSTRIES.md) | 業界別テンプレート / industry templates |
| [DEPLOY-ORACLE.md](DEPLOY-ORACLE.md) | 無料クラウド構成（Oracle）/ free-tier deployment |
| [DEPLOY-GCP.md](DEPLOY-GCP.md) | 無料クラウド構成（Google Cloud）/ free-tier deployment |
| [DEPLOY-AZURE.md](DEPLOY-AZURE.md) | 無料クラウド構成（Azure）/ free-tier deployment |
| [DEPLOY-AWS.md](DEPLOY-AWS.md) | 無料クラウド構成（AWS EC2）/ free-tier deployment |
| [DEPLOY-VPS.md](DEPLOY-VPS.md) | 有料 VPS 構成（さくらの VPS 等）/ paid VPS deployment |
| [SECURITY.md](SECURITY.md) | 脆弱性の報告 / reporting a vulnerability |
| [DEPLOY-HETZNER.md](DEPLOY-HETZNER.md) | 有料 VPS 構成（Hetzner）/ paid VPS deployment |
